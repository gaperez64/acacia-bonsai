...
#if ACACIA_ENABLE_AUT_PREPROCESSOR_STANDARD
#include "aut_preprocessors/standard.hh"
#endif

#if ACACIA_ENABLE_AUT_PREPROCESSOR_SURELY_LOSING
#include "aut_preprocessors/surely_losing.hh"
#endif

#if ACACIA_ENABLE_AUT_PREPROCESSOR_ELEVATOR
...
#if ACACIA_ENABLE_BOOLEAN_STATES_NO_BOOLEAN_STATES
...
#if ACACIA_ENABLE_ACTIONER_STANDARD
...
#if ACACIA_ENABLE_IOS_PRECOMPUTER_FAKE_VARS
#include "ios_precomputers/fake_vars.hh"
#endif

#if ACACIA_ENABLE_IOS_PRECOMPUTER_POWSET
#include "ios_precomputers/powset.hh"
#endif

#if ACACIA_ENABLE_IOS_PRECOMPUTER_STANDARD
#include "ios_precomputers/standard.hh"
#endif

#if ACACIA_ENABLE_IOS_PRECOMPUTER_MONA
...
#if ACACIA_ENABLE_INPUT_PICKER_CRITICAL_FULLRND
#include "input_pickers/critical_fullrnd.hh"
#endif

#if ACACIA_ENABLE_INPUT_PICKER_CRITICAL_PQ
#include "input_pickers/critical_pq.hh"
#endif

#if ACACIA_ENABLE_INPUT_PICKER_CRITICAL_RND
