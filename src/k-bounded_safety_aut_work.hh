...
class k_bounded_safety_aut_work_detail {
  ...
  public:
    k_bounded_safety_aut_work_detail (spot::twa_graph_ptr aut, int K,
                                      bdd input_support, bdd output_support,
                                      int verbose,
                                      const AutPreprocessingMaker& aut_preprocessing_maker,
      ...
      gen {0},
      aut_preprocessing_maker {aut_preprocessing_maker},
    ...
    bool solve () {
      ...
      // Make and run the preprocessor.
      (aut_preprocessing_maker.make (aut, input_support, output_support, K, verbose)) ();
...
static auto k_bounded_safety_aut_work_maker (const spot::twa_graph_ptr& aut, int K,
                                             ...
                                             const InputPickerMaker& input_picker_maker,
                                             const SafeStatesMaker& safe_states_maker) {
  return k_bounded_safety_aut_work_detail<SetOfStates, AutPreprocessingMaker, IOsPrecomputationMaker, ActionerMaker, InputPickerMaker, SafeStatesMaker>
    (aut, K, input_support, output_support, verbose, aut_preprocessing_maker, ios_precomputation_maker, actioner_maker, input_picker_maker, safe_states_maker);
}
...
static auto k_bounded_safety_aut_work (const spot::twa_graph_ptr& aut, int K,
  ...
  return k_bounded_safety_aut_work_maker<SetOfStates> (aut, K, input_support, output_support, verbose,
                                                       aut_preprocessing::surely_losing (),
