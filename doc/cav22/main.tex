...
\paragraph{Acacia-Bonsai and foes.}  The survival (a.k.a. cactus)
plot from \Cref{fig:cactus} shows the performance of the tools.  Since these tools tend to solve a
...
\paragraph{Acacia-Bonsai and Strix.} Observe that, in the graph from
\Cref{fig:cactus}, Strix and Acacia-Bonsai seem on par overall. A quick inspection of the
