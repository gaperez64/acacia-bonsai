...
This append updates the P0-only inventory above; the original inventory and manifest remain historical. Newly executed elsewhere in the sprint: the single [P0 cohort/worker/profile diagnostic](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/p0-diag); five-pair [P3a](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/screens/p3a), [P1a](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/screens/p1a) and [P4](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/screens/p4) screens; the **51 s diagnostic-only** [GF-G follow-up](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/diag-gfg7); one [P2 exploratory portfolio round](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/screens/p2-explore); [P2 mechanism, A/B/C and real-arm diagnostics](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/diag-p2mech); and the **three-round-per-side, 51 s** [workstation adjudication](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/diag-wsr). [screens.md](screens.md) is the consolidated ledger of drivers, binaries, flags, target hashes, rounds, caps and outcomes. Tests and mutation reviews are recorded under [codex](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/codex), summarized in [decisions.md](decisions.md).

P4's evaluator first reported UNRESOLVED: five **0/5 → 5/5** gains but workstation **1/5 → 0/5**. The longer-cap diagnostic finds control **15.8–17.8 s** versus treatment **38.5–42.6 s**, with different winning real workers at the same K=20. **P4 is rejected** under the set rule; the closing candidate retains the shipped four arms.

**Remeasurement decision:** the closing sequence measures **all three headline series afresh in the same epoch**: candidate `cand-hints-4cbf975c` / `otf_sparse_formula_loss_hints`, frozen baseline `candidate-f7919b83` / `otf_sparse_formula`, and ltlsynt. The 2026-09-15/16 observations remain historical selection evidence; they are not reused as primary headline rows. The reason is measured near-cap drift: the earlier five-versus-four repetitions report workstation **4/5 for the four-arm configuration** ([prior sprint §D](../COVERAGE-DIRECTED-FORWARD-SPRINT.md#d-family-level-frontiers)), versus this sprint's same-arm-configuration controls at **0/5** in [P1a admission.tsv](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/screens/p1a/admission.tsv) and **1/5** in [P4 admission.tsv](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/screens/p4/admission.tsv). These are the same arm configuration, not identical binaries/policies: P1a control includes P3a and verify-all; P4 control is P3a-free with hints. GF-G-contradiction7's no-hint screen/longer-cap observations span roughly **16.4–17.6 s** ([P3a screen](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/screens/p3a), [P1a controls](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/screens/p1a), [diag-gfg7](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/diag-gfg7)). These observations make cross-epoch near-cap timing reuse unsuitable; they do not isolate a cause of drift or erase package regressions.

**Closing execution — PENDING, campaign running:** [seq-candidate.sh](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/scripts/seq-candidate.sh) freezes the preset build and checks its compiled policy/arms; [closing.sh](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/scripts/closing.sh) starts with five alternating interaction pairs on [targets/combined.list](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/targets/combined.list) (14 IDs; SHA-256 `3f50e7212f4e8ff398cef89c71cc2592cfd51f65b7e58d1bfdfa8486555a310b`) against frozen `candidate-f7919b83`. It then schedules G0, G1, candidate G4, G3 and G2s, fresh full SYNTCOMP26 candidate/baseline/ltlsynt observations at uniform 17 s, bounded confirmations, `export-cactus` and `cactus-report`. Raw destination: [closing-run](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/closing-run); publication destination: [closing/](closing/) (pending). This describes the sequence, not completed gate/campaign results; a completion marker alone does not establish that every gate/export passed.

**Gate reuse/skip decisions:** reuse baseline G4 from [_bm-logs.20260915-closing/g4-candidate.gate.log](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260915-closing/g4-candidate.gate.log), **Ok 575, Fail 0, Timeout 49**, for the same frozen `f7919b83` binary (SHA-256 `0f4f48b6b751be91d9e0575105d4678d47dbccb8c998c01d71f9597abe22fb99`). The log's SHA-256 is `1367d696a7383c84166c110ec8f1c24e9e7823cdc34f46ca79684271246907b2`; candidate G4 is scheduled afresh. **Skip G5** because TLSF frontend/conversion is unchanged, and **skip posets checks** because posets is unchanged, following plan §9.2. These are reuse/scope decisions, not newly passed gates. G2s remains in the closing sequence.

Reused: the frozen corpus/map, historical closing/isolated-arm evidence for selection, the existing coverage runner, worker reporter, provider replay, external adapter/conversion cache and shared PAR-2/cactus tooling. These documentation reports read saved observations only; no solver, build, test, profiling or benchmark was run for this task. [evidence-sha256.tsv](evidence-sha256.tsv) preserves the earlier checkpoint; later identities are in [screens.md](screens.md). Bulky raw logs were not copied.

Invalidated inference, not deleted evidence: the P1a flag screen used `p1a-d14cf955`, which **contained rejected P3a**; it is not a completed retention check on the P3a-free preset candidate. P3a fails admission; its 51 s answers never count as 17 s coverage. P2's one-round gains are exploratory and include a loss; its first-row blocker leaves code/tests on the research branch. The §5.9 diagnostic also inherited P3a rather than meeting the originally requested P3a-off condition. Neither diagnostic solo-arm wins nor historical five-arm unions establish an admissible P4 replacement. **P1a retention and §9.6 closing artifacts remain pending.**
