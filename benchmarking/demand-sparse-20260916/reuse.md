...
**Closing execution (completed 2026-09-17):** [closing.sh](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/scripts/closing.sh) froze the P0+P1a preset build, ran its interaction check (UNRESOLVED), G0/G1/G4/G3/G2s, fresh full-SYNTCOMP26 rows for that candidate (04:13–06:05 UTC), the frozen baseline (06:06–07:58) and ltlsynt (08:00–09:22), and five-pair confirmations. After P1a was not admitted, [closing2.sh](/home/gperez/GIT-repos/acacia-bonsai/_bm-logs.20260916-demand-sparse/scripts/closing2.sh) built the P0-only binary, ran G0/G2s/G1/G4/G3, one more full campaign (13:31–15:23) and its confirmations; 51 s adjudications, a same-path rebuild control and forward-arm perf attribution followed. Nothing was admitted, so the required report reuses the baseline rows for the candidate label; all Acacia rows come from this one epoch and no 2026-09-15/16 row was reused. ltlsynt's SyFCo conversion cache was seeded from the 2026-09-15 run's identical conversions (conversion is untimed). See [closing/README.md](closing/README.md).
