# Frontier dossier: `arbiter_with_buffer`

- **family key**: `param:tlsf/arbiters_zoo/parametric/arbiter_with_buffer.tlsf`
- **failure kind at the boundary**: time_limit
- **points observed in 2026**: 10
- **frozen targets from this family**: `arbiter_with_buffer_pb_6_pe_.ltl`

## Parameter series

| parameters | B | S | F | B time |
|---|---|---|---|---:|
| n=1 | REALIZABLE | REALIZABLE | REALIZABLE | 0.01 |
| n=2 | REALIZABLE | REALIZABLE | REALIZABLE | 0.02 |
| n=3 | REALIZABLE | REALIZABLE | REALIZABLE | 0.04 |
| n=4 | REALIZABLE | REALIZABLE | REALIZABLE | 0.10 |
| n=5 | REALIZABLE | REALIZABLE | REALIZABLE | 4.68 |
| n=6 | TIMEOUT | TIMEOUT | TIMEOUT | 60.07 |
| n=7 | TIMEOUT | TIMEOUT | TIMEOUT | 60.11 |
| n=8 | TIMEOUT | TIMEOUT | TIMEOUT | 60.17 |
| n=9 | TIMEOUT | TIMEOUT | TIMEOUT | 60.13 |
| n=10 | TIMEOUT | TIMEOUT | TIMEOUT | 60.13 |

## Boundary

- largest solved: `arbiter_with_buffer_pb_5_pe_.ltl` (4.66 s)
- first unsolved: `arbiter_with_buffer_pb_6_pe_.ltl` (TIMEOUT)

## Worker mechanism at the boundary

| target | aut states | rank coords | actions/pass | workers |
|---|---:|---:|---:|---:|
| `arbiter_with_buffer_pb_6_pe_.ltl` | 1377 | 19 | 188416 | 21 |
