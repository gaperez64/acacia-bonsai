...
#### Winning strategies. {#winning-strategies. .unnumbered}
...
A universal $K$-co-Büchi (UKcB) automaton is an automaton $\mathcal{N}=
...
Consider input and output alphabets $I$ and $O$, a limit-deterministic
